...
m6$save_object(file = modfit_name) #save stan output so you don't have re-run model
#m6 <- readRDS(modfit_name)
...
#str(post6, list.len=100)
saveRDS(post6, modpost_name)
#post6 <- readRDS(modpost_name)
#post6$"GrpOffset[1]"
