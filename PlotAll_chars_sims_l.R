...
pdf(file="./Plots/Chars_sims_l.pdf",
    height=20, width=20)
...
text("10 idv, 10 meas, 1 int", x=-3.5, y=1, cex=3)
text("20 idv, 5 meas, 2 int", x=-3.5, y=-13, cex=3)
text("30 idv, 25 meas, 1 int", x=-3.5, y=-27, cex=3)
