...
######## single 10 characteristics

post6_s10_1 <- readRDS(modpost_name1) # single, 10 1
post6_s10_2 <- readRDS(modpost_name2) # single, 10 2
post6_s10_3 <- readRDS(modpost_name3) # single, 10 3
post6_s10_4 <- readRDS(modpost_name4) # single, 10 4
post6_s10_5 <- readRDS(modpost_name5) # single, 10 5
...
######## single 100 characteristics

post6_s100_1 <- readRDS(modpost_name6) # single, 100 1
post6_s100_2 <- readRDS(modpost_name7) # single, 100 2
post6_s100_3 <- readRDS(modpost_name8) # single, 100 3
post6_s100_4 <- readRDS(modpost_name9) # single, 100 4
post6_s100_5 <- readRDS(modpost_name10) # single, 100 5
...
######## single 200 characteristics

post6_s200_1 <- readRDS(modpost_name11) # single, 200 1
post6_s200_2 <- readRDS(modpost_name12) # single, 200 2
post6_s200_3 <- readRDS(modpost_name13) # single, 200 3
post6_s200_4 <- readRDS(modpost_name14) # single, 200 4
post6_s200_5 <- readRDS(modpost_name15) # single, 200 5
...
pdf(file="./Plots/Chars_sims_nu.pdf",
    height=20, width=20)
...
text("10 individuals", x=-3.5, y=1, cex=3)
text("100 individuals", x=-3.5, y=-13, cex=3)
text("200 individuals", x=-3.5, y=-27, cex=3)
