...
pdf(file="./Plots/Params_phases_combined_sims_100.pdf",
    height=20, width=20)
...
text("100 idv, est age", x=5, y=11, cex=3.65)
text("100 idv, est, no wt", x=17, y=11, cex=3.65)
text("50 idv, est age, 2 ms", x=28, y=11, cex=3.65)
...
pdf(file="./Plots/Params_phases_combined_sims2_100.pdf",
    height=20, width=20)
...
text("100 idv, est age", x=5, y=11, cex=3.65)
text("100 idv, est, no wt", x=17, y=11, cex=3.65)
text("50 idv, est age, 2 meas", x=28, y=11, cex=3.65)
