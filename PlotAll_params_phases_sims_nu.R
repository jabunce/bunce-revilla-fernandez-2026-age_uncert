...
pdf(file="./Plots/Params_phases_combined_sims_nu.pdf",
    height=20, width=20)
...
text("10 individuals", x=5, y=11, cex=3.65)
text("100 individuals", x=17, y=11, cex=3.65)
text("200 individuals", x=28, y=11, cex=3.65)
...
pdf(file="./Plots/Params_phases_combined_sims2_nu.pdf",
    height=20, width=20)
