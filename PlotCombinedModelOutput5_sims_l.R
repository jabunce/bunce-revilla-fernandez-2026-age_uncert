...
pdf(file="./Plots/Combined_plots_h_traj_l.pdf",
    height=20, width=10)
...
################### 10 individuals, measured 10 times, 1 year intervals
  ...
  for ( i in 1:length(Mat.fem.PID) ) {
    ...
    lines(x=Mat.fem.sort[which(Mat.fem.sort$PID == Mat.fem.PID[i]),"ObsAge"],
          ...
          col="black", lwd=MatIndivTraj_lwd, type="l")
...
#graphics.off()
 ...
 text(3, 170, "10 individuals, measured 10 times, 1 year intervals", cex = 1.35, adj=0)
...
#graphics.off()
 ...
 text(3, 170, "20 individuals, measured 5 times, 2 year intervals", cex = 1.35, adj=0)
...
#graphics.off()
 ...
 text(3, 170, "30 individuals, measured every year", cex = 1.35, adj=0)
