...
pdf(file="./Plots/Combined_plots_h_traj_nu.pdf",
    height=20, width=10)
...
#graphics.off()
 ...
 text(3, 170, "10 individuals", cex = 1.35, adj=0)
...
#graphics.off()
 ...
 text(3, 170, "100 individuals", cex = 1.35, adj=0)
...
#graphics.off()
 ...
 text(3, 170, "200 individuals", cex = 1.35, adj=0)
