...
pdf(file="./Plots/I_combined_100.pdf",
    height=20, width=20)
...
# row labels
text("100 idv, est age", x=-4.5, y=1, cex=3)
text("100 idv, est, no wt", x=-4.5, y=-11.5, cex=3)
text("50 idv, est age, 2 ms", x=-4.5, y=-24, cex=3)
